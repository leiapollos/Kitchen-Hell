...
public class SalmonWithPotatoes : Dish
{
    public SalmonWithPotatoes() : base()
    {
        this.reward = 70;
        this.successProbability = 0.86f;
        ...
        ing1.ingredient = IngredientType.Salmon;
        Ingredient ing2 = new Ingredient();
        ing2.ingredient = IngredientType.Potato;
