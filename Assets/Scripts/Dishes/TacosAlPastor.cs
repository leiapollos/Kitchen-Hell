...
public class TacosAlPastor : Dish
{
    public TacosAlPastor() : base()
    {
        this.reward = 75;
        this.successProbability = 0.825f;
        ...
        ing1.ingredient = IngredientType.Meat;
        Ingredient ing2 = new Ingredient();
        ing2.ingredient = IngredientType.Fajita;
        Ingredient ing3 = new Ingredient();
        ing3.ingredient = IngredientType.Onion;
