...
public class OmeletteCheese : Dish
{
    public OmeletteCheese() : base()
    {
        this.reward = 65;
        this.successProbability = 0.895f;
        ...
        ing1.ingredient = IngredientType.Egg;
        Ingredient ing2 = new Ingredient();
        ing2.ingredient = IngredientType.Egg;
