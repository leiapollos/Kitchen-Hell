...
public class GourmetHamburger : Dish
{
    public GourmetHamburger() : base()
    {
        this.reward = 80;
        this.successProbability = 0.79f;
        ...
        ing1.ingredient = IngredientType.GroundMeat;
        Ingredient ing2 = new Ingredient();
        ing2.ingredient = IngredientType.Bun;
